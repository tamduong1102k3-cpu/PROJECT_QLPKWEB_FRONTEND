    ...
    fontFamily: 'Inter, sans-serif'
      ...
      gap: '12px'
        ...
        flexWrap: 'wrap'
          ...
          <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Đ Tìm tên dịch vụ..." style={{
          padding: '8px 14px',
          borderRadius: '8px',
          border: 'none',
          fontSize: '13px',
        ...
        boxShadow: '0 25px 60px rgba(0,0,0,0.3)'
          ...
          alignItems: 'center'
            ...
            fontSize: '15px'
                ...
                {modal === 'add' ? '➕ Thêm Dịch Vụ Mới' : 'ĐĐ Cập Nhật Dịch Vụ'}
              </div>
